    ...
    <div class="tentang-kami">
        ...
        <div class="right">
            ...
            <div class="content">
                ...
                <div class="biography">
                    <img src="img/Aufa.png" alt="Aufa">
                    <h1>Aufa Mutia</h1>
                    <p>Kalau ini Aufa namanya. Dia dari Solo dan anaknya aktif banget lo di Telkom. Sama kaya temen-temen yang lain dia Informatika juga dan di Brocoffe ini dia megang Front End. Ini kalau mau jadi manusia yang lebih baik, banyak-banyak kenalan ma dia</p>
                </div>
            </div>
        </div>
    </div>
