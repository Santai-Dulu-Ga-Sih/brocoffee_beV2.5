    ...
    <div class="tentang-kami">
        ...
        <div class="right">
            ...
            <div class="content">
                ...
                <div class="brief-tentang-kami">
                    <h1>Jadi Penikmat Kopi Bukan Peminum Kopi</h1>
                    <p>Kopi adalah teman</p>
                    <p>Kopi sebagai teman berfokus pada menit,menjadi teliti atas setiap detail. Semua yang dilakukan dianggap memberikan pengalaman kesederhanaan dengan substansi yang tak tertandingi.</p>
                </div>
            </div>
        </div>
    </div>
